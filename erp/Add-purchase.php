						...
						<section id="page-title">
							<div class="row">
								<div class="col-sm-8">
									...
									<h1 class="mainTitle">Add Purchase</h1>
						...
						<section>
							  <div class="modal-body">
                                <form id="FormPurchase" action="" method="post" enctype="multipart/form-data">
                                    ...
                                    <input type="hidden" id="purchase_invoice_id" name="purchase_invoice_id" value="<?php echo $in_id ?>">
                                    <div class="form-group">
                                        <div class="row">
                                            <div class="col-md-6">
                                                <label for="name" class="col-form-label">Purchase Date</label>

                                                <input class="form-control datepicker" name="purchase_payment_date" id="purchase_payment_date" data-date-format="mm/dd/yyyy" placeholder="dd/mm/yyyy" type="date" autocomplete="off">
