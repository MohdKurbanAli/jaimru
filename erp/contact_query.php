...
if (isset($_POST['delete'])) {
    if (count($_POST['ids']) > 0) {
        ...
        $dl_qry = mysqli_query($class->conn, "DELETE FROM contact_qry WHERE  id in ($ids)") or die(mysqli_error());
        if ($dl_qry) {
			
			 echo "<script> alert('Query deleted successfully.');
                     window.location = 'contact_query.php';
                        ...
                        <div class="main-content">
                            <div class="wrap-content container" id="container">
                                ...
                                <section id="page-title">
                                    <div class="row">
                                        <div class="col-sm-8">
                                            <h1 class="mainTitle">Contact Page Query </h1>
                                            <span class="mainDescription">Query List</span>
                                        </div>
                                        <ol class="breadcrumb">
                                            <li>
                                                <span>Home</span>
    ...
    <script>
        ...
        $(document).ready(function(){
            var dataTable=$('#example1').DataTable({
                ...
                "serverSide":true,
                "ajax":{
					"url": "includes/ajax_contact_query.php",
                    type:"post"
                }
            });
        });
