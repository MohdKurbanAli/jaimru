					...
					<div class="wrap-content container" id="container">
                        ...
                        <table width="100%" class="table table-bordered" >
						  ...
						  <th rowspan="2">S. No.</th>
                            <th rowspan="2">Category of Services</th>
							<th rowspan="2">Qty.</th>
...
//							$amount = round(((int)$dn_res['at_attandance'])/$d * ((int)$dn_res['emp_unit']) * ((int)$dn_res['qty']) );
						?>						 
							<tr class="text-center">	
								...
								<td class="text-left"><?php echo $dn_res['emp_designation']; ?></td>
								<td><?php echo $dn_res['qty'] ?></td>
								...
								$amount = round(((int)$billing_days)/$d * ((int)$dn_res['emp_unit']) * ((int)$dn_res['qty']) );
                          ...
                          <tr class="text-right">
                            ...
                            <?php $wo_oraganisation_name =  trim($wdq_res['wo_oraganisation_name']);
                            if($wo_oraganisation_name != ''){
                                ?>
						  <tr class="text-right">
                            <td></td>
							<td colspan="8" class="text-right"><strong>CGST @9%</strong></td>
							<td><?php echo round(($sub_total*9)/100); ?></td>
                          </tr>
						  <tr class="text-right">
                            <td></td>
							<td colspan="8" class="text-right"><strong>SGST @9%</strong></td>
							<td><?php echo round(($sub_total*9)/100); ?></td>
                          </tr>
                        <?php }else{?>
                            <tr class="text-right">
                                <td></td>
                                <td colspan="8" class="text-right"><strong>IGST @18%</strong></td>
                                <td><?php echo round(($sub_total*18)/100); ?></td>
                            </tr>
                            <?php } ?>

						  <tr class="text-right">
                            <td></td>
							<td colspan="8" >	<strong>Grand Total (In Indian Rupees)</strong></td>
							<td rowspan="2" ><strong><?php $grand_total = round($sub_total + (($sub_total*9)/100) + (($sub_total*9)/100));
														echo $grand_total;
													?>
											 </strong>
							</td>
						  ...
						  <tr>
                            <td></td>
							<td colspan="8" class="text-right"><strong>
							<?php 
								$final_amount = round($sub_total + (($sub_total*9)/100) + (($sub_total*9)/100));
								echo ucwords($class->getIndianCurrency($final_amount)); 
							?>
							</strong></td>
						...
						<div class="col-md-12 margin-top-10">
						 <table width="100%" class="table table-bordered">
							 <tr>
								 <td width="60%">Registration No. of Company</td>
								 <td>U72900DL2014PTC262988</td>
							 </tr>
						<!--	 <tr>
							  <td>Employee's Provident Fund(EPF) Registration No.</td>
							 <td>UP/VNS/0059269/000/2013-2014/137658</td>
							</tr>
						
							<tr>
							<td>Employee's State Insurance Corporation(ESIC) Registration No.</td>
							 <td>280005025800000999</td>
						 </tr>
						 <tr>
							 <td>Labour License No.</td>
							 <td>MIRZA 218/494</td>
						 </tr>
						 -->
                             <tr>
                                 <td>GSTIN No.</td>
                                 <td>
								 <?php $gst_delhi = "07AAHCP5991R1ZD";
										$gst_jharkhand = "";
								 if($wo_oraganisation_name =='JAP IT')
								 {
									 echo $gst_jharkhand;
								 }else{
									 echo $gst_delhi;
						 ...
						 <tr>
							 <td>e-mail</td>
							 <td>sahasha@prakharsoftwares.com</td>
						 </tr><tr>
                        ...
                        <div class="col-md-12" style="margin-top:10px">
							<div class="">
								<p><strong>NOTE:</strong> Please make all payment by cheque /DD in favour of <strong>PRAKHAR SOFTWARE SOLUTIONS PVT. LTD</strong>, Payable at New Delhi.<br>
								<strong><u>BANK DETAILS:</u> <br>
								Bank Name: YES BANK LTD. | ACCOUNT NO. 010 7838 0000 3722 | IFSC CODE: YESB0000107</strong><br>
								Branch: Mother Diary Road, Shakarpur, Delhi – 110092</p>
							</div>
                        ...
                        <?php if($wo_oraganisation_name == 'NICSI'){  ?>
                            <a href="other_doc.php?wo=<?php echo $wo_number ?>&projectno=<?php echo $wdq_res['wo_project_number']; ?>&month=<?php echo $month_date ?>&periodfrom=<?php echo $class->sqlToUser_DateTime($wdq_res['wo_date_of_issue']);?>&wostart=<?php echo $wdq_res['wo_start_date']; ?>&woend=<?php echo $wdq_res['wo_end_date']; ?>&totalmanpower=<?php echo $totalmanpower ?>&invoice_number=<?php echo $invoice_number ?>&billamount=<?php echo round($sub_total); ?>" class="btn btn-warning pull-right" target="_blank">
                                Other Doc
                            </a>
                        <?php } ?>
						
                            <a href="encloser.php?wo=<?php echo $wo_number ?>&projectno=<?php echo $wdq_res['wo_project_number']; ?>&month=<?php echo $month_date ?>&periodfrom=<?php echo $class->sqlToUser_DateTime($wdq_res['wo_date_of_issue']);?>&wostart=<?php echo $wdq_res['wo_start_date']; ?>&woend=<?php echo $wdq_res['wo_end_date']; ?>&totalmanpower=<?php echo $totalmanpower ?>&invoice_number=<?php echo $invoice_number ?>&billamount=<?php echo round($sub_total); ?>" class="btn btn-success pull-right" target="_blank">
                                Encloser
                            </a>
