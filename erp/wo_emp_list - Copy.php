									...
									<table class="table table-striped table-bordered table-hover table-full-width" id="">
										...
										?>
											<tr>
												...
												<td><input name="attendance[]" type="number" min="0" max="31"   class="form-control attendance" value="<?php // echo $at_attandance ?>" > </td>
												<td width="8%"><input name="leave[]" type="number" min="0" max="31"  class="form-control leave" value="<?php // echo $at_leave ?>" ></td>
